...
const includedEquipment = [
  {
    name: '正压稀相气力输送',
    img: '/ref-images/image_20221104_1667522586_485596.png',
  },
]
          ...
          <div className="page-container">
            ...
            <div className="sub-bento-grid fade-up fade-up-delay-1">
              <div className="sub-bento-main">
                <img src="/ref-images/image_20221013_1665648798_928908.jpg" alt="气力输送系统展示" loading="lazy" />
              </div>
              <div className="sub-bento-accent">
                <span className="sub-bento-accent-num">PC</span>
                <span className="sub-bento-accent-label">System Display</span>
                <p className="sub-bento-accent-title">全密闭输送 零粉尘泄漏</p>
              </div>
              <div className="sub-bento-secondary">
                <img src="/ref-images/upfile_image_20221013_1665665001_862038.jpg" alt="气力输送系统" loading="lazy" />
              </div>
            </div>
          </div>
        </section>
