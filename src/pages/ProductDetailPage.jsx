...
const productMap = {
  ...
  'chemical': {
    ...
    products: {
      ...
      'reciprocating-mixer': { name: '往复式混合机', intro: '独特的往复运动搅拌方式，适合中低粘度物料的温和混合。', features: ['往复运动搅拌', '低剪切温和混合', '适合热敏物料', '清洗方便'], components: ['往复搅拌臂', '搅拌容器', '驱动系统', '控制面板'], params: [{ model: 'HY-RCM-200', capacity: '200L', power: '15kW', speed: '0-120次/min', size: '1400×1000×2000mm' }] },
      ...
      'planetary-butterfly': { name: '行星蝶式混合机', intro: '行星运动+蝶式桨叶的组合，适用于触变性物料的高效混合。', features: ['蝶式桨叶设计', '适合触变性物料', '分散效果好', '出料方便'], components: ['蝶式桨叶', '搅拌缸', '升降系统', '变频控制'], params: [{ model: 'HY-PBM-500', capacity: '500L', power: '55kW', speed: '0-100rpm', size: '2200×1800×3200mm' }] },
          ...
          <div className="page-container">
            ...
            <div className="detail-intro-grid">
              <div className="detail-intro-text">
                {(product?.intro || detail?.summary) && <p>{product?.intro || detail.summary}</p>}
                {product?.features && (
                  <>
