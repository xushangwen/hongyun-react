...
const productMap = {
  ...
  'dual-column-planetary': { name: '双立柱行星搅拌机',   img: `${EQ}/03-dual-column-planetary.jpg` },
  ...
  'vertical-kneader':      { name: '立式捏合机',         img: `${EQ}/07-vertical-kneader.png`      },
  'press-machine':         { name: '压料机',             img: `${EQ}/08-material-press.png`        },
  'tilting-machine':       { name: '倾倒机',             img: `${EQ}/09-tilting-machine.png`       },
