...
const IMG = '/assets/images/solutions/wet-electrode-system/pipeline-mixer.webp'

export default function SsbPipelineMixerPage() {
  useEffect(() => {
  ...
  return (
    <>
      <PageHero
        title="管线式混合机"
        subtitle="Pipeline Mixer · 固态电池核心装备"
        bgImage={HERO_IMG}
      />
