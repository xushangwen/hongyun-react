...
export const productCategories = [
  {
    ...
    systems: [
      ...
      },
      {
        ...
        products: [
          { name: '高速循环高速分散机', slug: 'cp-disperser', image: '/assets/images/solutions/circulation-pulping/高速分散机-svg.svg', imgContain: true, imgSm: true },
          { name: '高速循环循环罐 A',    slug: 'cp-tank-a',    image: '/assets/images/solutions/circulation-pulping/循环罐-A-svg.svg',   imgContain: true, imgSm: true },
          { name: '高速循环循环罐 B',    slug: 'cp-tank-b',    image: '/assets/images/solutions/circulation-pulping/循环罐-B-svg.svg',   imgContain: true, imgSm: true },
        ],
      },
      {
        name: '双螺杆连续制浆系统',
