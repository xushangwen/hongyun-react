...
const row1Partners = [
  ...
  { logo: `${P}/par-logo-03.svg`, alt: '华为',     category: '胶粘剂领域', name: '华为' },
...
const row2Partners = [
  { logo: `${P}/par-logo-09.svg`, alt: 'TDK',     category: '新能源领域', name: 'TDK' },
  { logo: `${P}/par-logo-10.svg`, alt: '特斯拉',   category: '新能源领域', name: '特斯拉' },
...
const row3Partners = [
  { logo: `${C}/ne-rept.webp`,      alt: '瑞浦能源',     category: '新能源领域', name: '瑞浦能源' },
  { logo: `${C}/ne-hithium.webp`,   alt: '海辰储能',     category: '新能源领域', name: '海辰储能' },
  { logo: `${C}/ne-trina.webp`,     alt: '天合储能',     category: '新能源领域', name: '天合储能' },
  { logo: `${C}/ne-atl.webp`,       alt: 'ATL新能源科技', category: '新能源领域', name: 'ATL新能源科技' },
  { logo: `${C}/ne-ganfeng.webp`,   alt: '赣锋锂电',     category: '新能源领域', name: '赣锋锂电' },
  { logo: `${C}/ne-murata.webp`,    alt: '村田制作所',   category: '新能源领域', name: '村田制作所' },
  { logo: `${C}/ne-foxconn.webp`,   alt: '台湾鸿海',     category: '新能源领域', name: '台湾鸿海' },
  { logo: `${C}/ne-farasis.webp`,   alt: '孚能科技',     category: '新能源领域', name: '孚能科技' },
]

const row4Partners = [
  { logo: `${C}/ad-sika.svg`,      alt: '西卡',       category: '胶粘剂领域', name: '西卡' },
  { logo: `${C}/ad-foxconn.svg`,   alt: '富士康',     category: '胶粘剂领域', name: '富士康' },
  { logo: `${C}/ad-honeywell.svg`, alt: '霍尼韦尔',   category: '胶粘剂领域', name: '美国霍尼韦尔' },
  { logo: `${C}/ad-itw.png`,       alt: '依工聚合',   category: '胶粘剂领域', name: '依工聚合' },
  ...
  return (
    <section className="partners">
      <div className="partners-container">
        ...
        <ScrollRow partners={row5Partners} direction="left" />
